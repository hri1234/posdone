 ...
 const handleChange = (event) => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      const res = await fetch(`https://mohammad-backend.onrender.com/api/salesorder`);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(
        `https://mohammad-backend.onrender.com/api/salesorder`,
        {
          method: "DELETE",
        }
      );
        ...
        <div className="col">
          <div className="card shadow">
            <div className="card-header border-0">
              <h3 className="mb-0"style={{fontWeight:"900" , fontStyle:"italic"}}>SalesOrder Report</h3>
            </div>
